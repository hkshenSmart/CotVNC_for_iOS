...
#define rfbResetDecoder 0xe0   //insert by yzz
...
//add by x
#define RFB_ENCODING_POINTER_POS   0xFFFFFF18
...
#define myrfbAppSharingYes 1000  //@@@@@@@@@@@@ modify by yzz@@@@@@@@@@@@
#define myrfbAppSharingNo 1001    //@@@@@@@@@@@@ modify by yzz@@@@@@@@@@@@

typedef struct _myrfbAppInfo         //@@@@@@@@@@@@ modify by yzz@@@@@@@@@@@@
{
    uint32_t appthreadid;
    uint32_t titlelength;
    //followed by char title[titlelength]
}myrfbAppInfo;            //@@@@@@@@@@@@ modify by yzz@@@@@@@@@@@@
...
typedef struct _rfbFramebufferUpdateRequestMsg {
    ...
    CARD16 w;
    CARD16 h;
    uint32_t nBytes; //inset by yzz
} rfbFramebufferUpdateRequestMsg;

#define sz_rfbFramebufferUpdateRequestMsg 14
