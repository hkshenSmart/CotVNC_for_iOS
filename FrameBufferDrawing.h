...
{
    unsigned int pix = 0, col, tempr, tempb, tempg;
...
//    col += this->blueClut[(pix >> this->pixelFormat.blueShift) & this->pixelFormat.blueMax];
    ...
    tempr = ((pix >> this->pixelFormat.redShift) & this->pixelFormat.redMax) * 255 / this->pixelFormat.redMax;
    tempg = ((pix >> this->pixelFormat.greenShift) & this->pixelFormat.greenMax) * 255 / this->pixelFormat.greenMax;
    tempb = ((pix >> this->pixelFormat.blueShift) & this->pixelFormat.blueMax) * 255 / this->pixelFormat.blueMax;
    col = (tempr << 16) + (tempg << 8) + tempb;
    return col;
}
...
{
	FBColor* start;
    unsigned int stride, i, lines, col, tempr,tempb;
